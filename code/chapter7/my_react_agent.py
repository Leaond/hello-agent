...
from hello_agents1 import ReActAgent, HelloAgentsLLM,Config,Message,ToolRegistry

class MyReActAgent(ReActAgent):
    """
        重写ReAct Agent  推理与行动结合的智能体
    """
...
if __name__ == '__main__':
    myreactagent = MyReActAgent()
    myreactagent.run("今天成都的天气")
